...
本项目借鉴了 [Lilian Weng — Harness Engineering for Self-Improvement (2026)](https://lilianweng.github.io/posts/2026-07-04-harness/) 以及多个 SOTA 项目的设计理念。v2.6.5 新增 LinkAI Cloud 发布入口和 Agent Prompt 模板。
...
├── 多 Agent 入口     → Codex / Claude / Manus / Qoder CN / Lingma / LinkAI / 桌面端
