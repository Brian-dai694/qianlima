...
本项目借鉴了 [Lilian Weng — Harness Engineering for Self-Improvement (2026)](https://lilianweng.github.io/posts/2026-07-04-harness/) 以及多个 SOTA 项目的设计理念。v2.6.7 新增 QianlimaEval 运行质量评估层，吸收 MiniAppBench / MiniAppEval 的多维评分和证据轨迹思想。
