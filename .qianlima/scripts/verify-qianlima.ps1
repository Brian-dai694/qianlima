...
foreach ($file in @('WORKSPACE_INDEX.md', 'workspace-index.json', 'CODEX_BOOT.md', 'workflow-index.yaml', 'risk-rules.yaml', 'context-policy.yaml', 'model-adapters.yaml', 'model-pricing.json', 'skill-evolution.yaml', 'response-policy.yaml', 'task-runtime.yaml', 'world-model.yaml', 'data-sources.example.yaml', 'work.example.ws', 'specifications/skill-self-evolution-contract.json', 'specifications/qianlima-execution-plan-contract.json', 'specifications/qianlima-step-result-contract.json', 'specifications/qianlima-evr-contract.json', 'specifications/qianlima-readonly-runner-contract.json', 'specifications/qianlima-desired-state-diff-contract.json', 'specifications/qianlima-evidence-pack-contract.json', 'specifications/qianlima-project-scope-contract.json', 'specifications/qianlima-source-request-contract.json', 'specifications/qianlima-health-check-contract.json', 'specifications/qianlima-failure-receipt-contract.json', 'specifications/personal-professional-tool-governance.json', 'specifications/personal-harness-acceptance-matrix.json', 'specifications/personal-project-value-contract.json', 'specifications/personal-ad-ops-loop-contract.json', 'specifications/personal-ad-action-card-contract.json', 'scripts/get-model-cost.ps1', 'scripts/new-staged-response.ps1', 'scripts/save-hot-state.ps1', 'scripts/new-task-contract.ps1', 'scripts/set-task-control.ps1', 'scripts/check-task-contract.ps1', 'scripts/get-snapshot-decision.ps1', 'scripts/summarize-csv.ps1', 'scripts/update-tool-health.ps1', 'scripts/write-experience-event.ps1', 'scripts/get-quality-dashboard.ps1', 'scripts/new-skill-feedback-record.ps1', 'scripts/new-skill-patch-proposal.ps1', 'scripts/invoke-skill-self-evolution.ps1', 'scripts/test-skill-self-evolution.ps1', 'scripts/new-qianlima-execution-plan.ps1', 'scripts/new-qianlima-step-result.ps1', 'scripts/invoke-qianlima-evr.ps1', 'scripts/invoke-qianlima-readonly-runner.ps1', 'scripts/test-qianlima-execution-plan.ps1', 'scripts/new-qianlima-desired-state-diff.ps1', 'scripts/new-qianlima-evidence-pack.ps1', 'scripts/test-qianlima-state-diff.ps1', 'scripts/new-qianlima-project-scope.ps1', 'scripts/new-qianlima-source-request.ps1', 'scripts/invoke-qianlima-health-check.ps1', 'scripts/new-qianlima-failure-receipt.ps1', 'scripts/test-qianlima-operational-controls.ps1', 'scripts/simulate-professional-tool-governance.ps1', 'scripts/test-professional-tool-governance.ps1', 'scripts/test-personal-harness-acceptance.ps1', 'scripts/evaluate-personal-project-candidate.ps1', 'scripts/test-personal-project-value.ps1', 'scripts/invoke-personal-ad-ops-loop.ps1', 'scripts/test-personal-ad-ops-loop.ps1', 'workflows/skill_evolution.yaml', 'workflows/personal_ad_ops_loop.yaml', 'task-cards/skill-evolution.yaml', 'task-cards/personal-ad-ops-loop.yaml', 'templates/operational-snapshot_template.json', 'templates/experience-event_template.json', 'templates/token-usage-record_template.yaml')) {
